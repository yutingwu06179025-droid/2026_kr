        ...
        <div className="flex flex-row justify-between items-end">
          <div className="flex-1">
             <div className="flex items-center gap-2 md:gap-4 mb-4 md:mb-8">
                ...
                <span className="text-[8px] md:text-xs font-black tracking-widest text-[#A9DDF3] uppercase">Private Journey | 프라이빗</span>
             </div>
            ...
            <p className="text-sm md:text-xl opacity-90 flex items-center gap-2 font-bold">
              <span className="bg-[#A9DDF3] text-[#003399] px-3 py-1 rounded-full text-[10px] md:text-sm font-black tracking-widest">1월 9일 — 1月 17일</span>
            </p>
          </div>
          <div className="bg-white text-[#003399] p-4 md:p-8 rounded-[2rem] md:rounded-[3.5rem] text-center shadow-2xl min-w-[100px] md:min-w-[160px] ml-4">
            <p className="text-[7px] md:text-[10px] font-black uppercase mb-1 opacity-40">D-DAY | 출발</p>
